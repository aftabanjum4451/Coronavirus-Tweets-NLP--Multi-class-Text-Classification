...
## variant 1
The performance of several Classifiers is tested:
- **Naive Bayes**  and some **Ensemble Methods Ada boost (AB), Gradient Boosting Classifier (GBC), Random Forest (RF)**. Among those RF and GBC perfume well on this data set. Then I optimized the hyper-parameters of RF by using Randomized Search CV. At the end perfume the evaluation and calculate the accuracy.
